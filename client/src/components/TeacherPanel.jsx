...
const TeacherPanel = () => {
    ...
    const handleKickStudent = ({ name }) => {
        ...
        setStudentList(prevList => prevList.filter(student => student !== name));
    }
    ...
    return (
        <div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md max-w-2xl mx-auto mt-6 space-y-6">
                <h2 className="text-2xl font-semibold text-gray-800">🗳 Create a Poll</h2>

                <div>
                    <label className="block font-medium mb-1 text-gray-700">📚 Select Classroom</label>
                    <select
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <label className="block font-medium text-gray-700 mb-1">⏱️ Poll Duration (in seconds)</label>
                        <input
                            type="number"
                            min="10"
                            step="5"
            ...
            {submitted && !results && (
                <div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-800 p-4 rounded-lg mt-6 shadow">
                    ...
                    <p className="text-sm mt-1">
                        {liveVotes.answered} out of {liveVotes.total} students have submitted their answers.
                    </p>
                </div>
            )}
            ...
            {results && (
                <div className="bg-white p-6 mt-6 rounded-xl shadow-md max-w-2xl mx-auto">
                    <h3 className="text-xl font-semibold text-gray-800 mb-2">📊 Poll Results</h3>
                    ...
                    {pollHistory.length === 0 ? (
                        ...
                        <ul className="space-y-4">
                            {pollHistory.map((poll, index) => (
                                <li key={index} className="border border-gray-200 rounded-lg p-3 bg-gray-50">
                                    ...
                                    <p className="text-xs text-gray-500 mt-2">
                                        🗓 {new Date(poll.timestamp).toLocaleString()} — 🧑‍🎓 {poll.answeredCount}/{poll.totalStudents} students answered
                                    </p>
                                </li>
                            ))}
                        </ul>
